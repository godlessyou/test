...
public class AES { 
	...
	public static String encryptString(String content){
		return encryptString(content, Global.webProperties.DES_KEY);
	}
	/**
	 * 加密
	 * 
	...
	public static String decryptString(String content){
		return decryptString(content, Global.webProperties.DES_KEY);
	}
	/**
	 * 将二进制转换成16进制
	 * 
	...
	public static void main(String[]argus){
		String content = "testdsfdsf"; 
		String password = "12345678"; 
		//加密 
		System.out.println("加密前：" + content);  
		System.out.println("加密后：" + encryptString(content, password)); 
		
		//解密  
		String decryptResult = decryptString(encryptString(content, password),password); 
